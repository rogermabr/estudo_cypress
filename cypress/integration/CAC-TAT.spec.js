...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('exibe mensagem de erro quando o telefone se tornar obrigatorio mas não é preenchido antes do envio do formulário', function(){
        cy.get('#firstName').type('Roger')
        cy.get('#lastName').type('Albuquerque')
        cy.get('#email').type('roger@roger.com')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        ...
        cy.get('#lastName')
            ...
            .should('have.value', '')
        cy.get('#email')
            .type('roger@roger.com')
            .should('have.value', 'roger@roger.com')
            .clear()
            .should('have.value', '')
    ...
    it('marca o tipo de atendomento "Feedback"', function(){
    ...
    it('selectione um arquivo da pasta fixtures', function(){
